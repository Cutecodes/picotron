...
from picotron.data_parallel.data_parallel import DataParallelBucket, DataParallelZero3
from picotron.data_parallel.zero3 import Zero3Optimizer
...
if __name__ == "__main__":
    ...
    optimizer = Zero3Optimizer(model, lr=config["training"]["learning_rate"], **extra_args)
    ...
    if is_wandb_rank:
        ...
        print(f"理论节省: ~{(param_count*world_size/1e6*12*(1- 1/world_size)) :.2f}M")
        print("="*60 + "\n")

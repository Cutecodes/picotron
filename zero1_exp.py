...
if __name__ == "__main__":
    ...
    optimizer = ZeroOptimizer(model.parameters(), lr=config["training"]["learning_rate"], partition_grads=False, **extra_args)
    ...
    if is_wandb_rank:
        ...
        print(f"理论节省: ~{(param_count/1e6*8*(1- 1/world_size)) :.2f}M")
        print("="*60 + "\n")
